...
const Flashcards = () => {
  ...
  return (
    <div className="FlashCard-container">
      <h1 className="FlashCard-title">Flashcard <span>Generator</span></h1>
      {isLoggedIn && isSubscribed ? (
              ...
              <div className="FlashCard-item-container">
                {Object.entries(flashcards).map(([key, flashcard], index) => (
                  <div key={index} className="FlashCard-item">
                    ...
                    <button className="FlashCard-save" onClick={() => handleSaveFlashcard(JSON.stringify(flashcard), index)}>Save</button>
                  </div>
                ))}
              </div>
            </div>
        ...
        <p>Please log in to generate flashcards.</p>
      )}
